...
public class ReservationCalculatorApp {
	...
	public static void main(String[] args) {
		...
		while (choice.equalsIgnoreCase("y")) {
			...
			ard=Reservation.getArrivalDateFormatted(); //use the formated date, otherwise the line still works fine
			...
			String nightlyRate=Reservation.getNightlyRateFormatted();
